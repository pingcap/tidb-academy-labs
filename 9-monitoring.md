...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/workloads.png "Workloads")

After clicking on _demo-monitor_ select _Expose_ from the actions menu:

![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/actions.png "Actions > Expose")

You want to expose port 3000 to the Service type _Load balancer_:

![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/expose.png "Actions > Expose")
...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/waiting.png "Actions > Expose")
...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/final.png "Actions > Expose")
...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/grafana.png "Actions > Expose")

## Select the TiDB Dashboard

When you have logged in, select the *TiDB-Cluster-TiDB* dashboard:
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/select-dashboard.png "Actions > Expose")
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/tidb-dashboard.png "Actions > Expose")
...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/tidb-overview.png "Actions > Expose")
...
![alt text](https://github.com/pingcap/tidb-academy-labs/raw/master/alerts.png "Actions > Expose")
